...
internal static class JsonPropertyExtensions
{
    ...
    /// </summary>
    private readonly struct Utf8PropertyParserStateWrapper<TState, TResult>
    {
        public Utf8PropertyParserStateWrapper(Utf8PropertyParser<TState, TResult> parser, in TState state, bool decode)
        {
            this.Parser = parser;
            this.State = state;
            this.Decode = decode;
        ...
        public Utf8PropertyParser<TState, TResult> Parser { get; }
    ...
    /// </summary>
    private readonly struct PropertyParserStateWrapper<TState, TResult>
    {
        public PropertyParserStateWrapper(PropertyParser<TState, TResult> parser, in TState state)
        {
            this.Parser = parser;
            this.State = state;
        }

        public PropertyParser<TState, TResult> Parser { get; }
