...
/// </returns>
internal delegate bool Utf8Parser<TState, TResult>(ReadOnlySpan<byte> span, in TState state, [NotNullWhen(true)] out TResult? value);
...
///   <see langword="false"/> otherwise.
/// </returns>
internal delegate bool Parser<TState, TResult>(ReadOnlySpan<char> span, in TState state, [NotNullWhen(true)] out TResult? value);
...
///   <see langword="false"/> otherwise.
/// </returns>
internal delegate bool Utf8PropertyParser<TState, TResult>(ReadOnlySpan<byte> name, ReadOnlySpan<byte> span, in TState state, [NotNullWhen(true)] out TResult? value);
...
///   <see langword="false"/> otherwise.
/// </returns>
internal delegate bool PropertyParser<TState, TResult>(ReadOnlySpan<char> name, ReadOnlySpan<char> span, in TState state, [NotNullWhen(true)] out TResult? value);